...
const fr: DeepPartial<Vertalingen> = {
  ...
  instellingen: {
    ...
    uitnodigen: 'Inviter des amis',
    uitnodigenUitleg: 'Partagez votre code et gagnez des récompenses.',
  ...
  deel: {
    ...
    alsLink: 'Partager le lien',
    kopieerTekst: 'Copier le texte',
    sluiten: 'Fermer',
    gelukt: 'Partagé.',
    gekopieerd: 'Copié dans votre presse-papiers.',
  ...
  referral: {
    ...
    kop: 'Offrez une longueur d’avance à un ami',
    uitleg: 'Partagez votre code. Chaque ami qui vous rejoint vous rapporte une récompense.',
    jouwCode: 'Votre code d’invitation',
    ...
    beschikbaar: (n: number): string =>
      n === 1 ? '1 récompense à réclamer' : `${n} récompenses à réclamer`,
    geenBeloningen: 'Aucune récompense à réclamer pour l’instant.',
    beloningVerhaal: '1 histoire de plus',
    beloningVerhaalUitleg: 'Ouvrez une histoire de plus que la limite du jour.',
    beloningProWeek: 'Une semaine de Pro',
    beloningProWeekUitleg: (dagen: number): string =>
      `${dagen} jours sans limite quotidienne ni interruption.`,
    claim: 'Réclamer',
    geclaimdTitel: 'Récompense réclamée',
    geclaimdVerhaal: 'Vous pouvez ouvrir une nouvelle histoire de plus aujourd’hui.',
    geclaimdProWeek: (dagen: number): string => `Pro est à vous pour les ${dagen} prochains jours.`,
    ok: 'OK',
    geenCode: 'Connectez-vous pour obtenir votre code d’invitation.',
    hoeWerktKop: 'Comment ça marche',
    stap1: 'Partagez votre code avec un ami.',
    stap2: 'Il le saisit à l’inscription.',
    stap3: 'Vous recevez tous les deux une récompense.',
    nogNietActief:
      'La saisie d’un code n’est pas encore active : inviter ne rapporte donc pas encore de récompense. Votre code est bien réel et déjà le vôtre — il fonctionnera dès que l’échange sera disponible.',
  },
  collectie: {
